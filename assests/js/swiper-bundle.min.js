            ...
            if (((a.isTouched = !1), (a.isMoved = !1), (a.startMoving = !1), (p = i.followFinger ? (r ? t.translate : -t.translate) : -a.currentTranslate), !i.cssMode))
                if (i.freeMode) {
                    ...
                    if (i.freeModeMomentum) {
                        ...
                        if (y < t.maxTranslate())
                            i.freeModeMomentumBounce ? (y + t.maxTranslate() < -S && (y = t.maxTranslate() - S), (w = t.maxTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (y = t.maxTranslate()),
                                i.loop && i.centeredSlides && (T = !0);
                        else if (y > t.minTranslate())
                            i.freeModeMomentumBounce ? (y - t.minTranslate() > S && (y = t.minTranslate() + S), (w = t.minTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (y = t.minTranslate()),
                                i.loop && i.centeredSlides && (T = !0);
                                ...
                                p[I] && (p[I].swiperSlideSize = C),
                                    ...
                                    i.centeredSlides
                                        ? ((w = w + C / 2 + E / 2 + y),
                                          ...
                                          h.push(w))
                                        : (i.roundLengths && (w = Math.floor(w)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && c.push(w), h.push(w), (w = w + C + y)),
                                    (e.virtualSize += C + y),
                                    (E = C),
                                    (x += 1);
                            }
            ...
            slide: {
                slideTo: function (e, t, a, i, s) {
                    ...
                    if (((b = l > c ? "next" : l < c ? "prev" : "reset"), (h && -y === n.translate) || (!h && y === n.translate)))
                        return n.updateActiveIndex(l), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(y), "reset" !== b && (n.transitionStart(a, b), n.transitionEnd(a, b)), !1;
                    if (o.cssMode) {
                        var C,
                            S = n.isHorizontal(),
                            M = -y;
                    ...
                    return (
                        0 === t
                            ? (n.setTransition(0), n.setTranslate(y), n.updateActiveIndex(l), n.updateSlidesClasses(), n.emit("beforeTransitionStart", t, i), n.transitionStart(a, b), n.transitionEnd(a, b))
                            : (n.setTransition(t),
                              n.setTranslate(y),
                    ...
                    if (l && (!l || 0 !== Object.keys(l).length)) {
                        ...
                        if (o && e.currentBreakpoint !== o) {
                            ...
                            u && !c
                                ...
                                : !u && c && (n.addClass(r.containerModifierClass + "multirow"), "column" === p.slidesPerColumnFill && n.addClass(r.containerModifierClass + "multirow-column"), e.emitContainerClasses());
            ...
            handle: function (e) {
                ...
                if (t.enabled) {
                    ...
                    if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || (i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase())))) {
                        ...
                        t.isHorizontal()
                            ? ((p || u || c || h) && (n.preventDefault ? n.preventDefault() : (n.returnValue = !1)), (((u || h) && !s) || ((p || c) && s)) && t.slideNext(), (((p || c) && !s) || ((u || h) && s)) && t.slidePrev())
    ...
    var Z = {
        ...
        J = {
            ...
            init: function () {
                ...
                ((a.params.navigation = P(a.$el, a.params.navigation, a.params.createElements, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), i.nextEl || i.prevEl) &&
                ...
                if (e.params.scrollbar.el) {
                    ...
                    o &&
                        (l.touch
                            ...
                            : (o.removeEventListener(s.start, e.scrollbar.onDragStart, d), t.removeEventListener(s.move, e.scrollbar.onDragMove, d), t.removeEventListener(s.end, e.scrollbar.onDragEnd, p)));
                }
            },
            init: function () {
                var e = this,
        ...
        ce = {
            setTranslate: function () {
                for (
                    ...
                    Math.abs(x) < 0.001 && (x = 0), Math.abs(E) < 0.001 && (E = 0), Math.abs(y) < 0.001 && (y = 0), Math.abs(g) < 0.001 && (g = 0), Math.abs(b) < 0.001 && (b = 0), Math.abs(T) < 0.001 && (T = 0);
            ...
            init: function () {
                ...
                return (
                    t.swiper instanceof a
                        ? ((e.thumbs.swiper = t.swiper), S(e.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), S(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
                    ...
                    if (t.realIndex !== a.realIndex || r) {
                        ...
                        r && (n += "next" === l ? s : -1 * s),
                            a.visibleSlidesIndexes &&
                                ...
                                (a.params.centeredSlides ? (n = n > o ? n - Math.floor(i / 2) + 1 : n + Math.floor(i / 2) - 1) : n > o && a.params.slidesPerGroup, a.slideTo(n, e ? 0 : void 0));
                    }
                    var u = 1,
